...
import profilepicture from '../../assets/Profile2-noBG.png';
const About = () => {
	return (
		<div>
			<section class='pt-10 overflow-hidden bg-white-50 md:pt-0 sm:pt-16 2xl:pt-16'>
				<div class='px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl  bg-white rounded-2xl'>
					<div class='grid items-center grid-cols-1 md:grid-cols-2'>
						...
						<div class='relative'>
							...
							<img
								class='relative w-full xl:max-w-lg xl:mx-auto 2xl:origin-bottom '
								src={profilepicture}
								alt=''
							/>
						</div>
