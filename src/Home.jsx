            ...
            <div class="grid items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
              <div class=" bg-white p-10 rounded-xl">
                ...
                <p class="max-w-lg mt-3 text-xl sm:text-sm md:text-md lg:text-xl leading-relaxed text-gray-600 md:mt-8">
                  I'm a software engineer based in the Philippines. With two
                  years of experience under my belt as a software engineer, I
                  possess a robust skillset in web development, particularly in
                  building high-performance, dynamic applications using Next.js.
                </p>
